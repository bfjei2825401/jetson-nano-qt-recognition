...
string MyRecognition::getDescription()
{
    return this->description;
}

string MyRecognition::getConfidence()
{
    return this->confidence;
}

string MyRecognition::getClassIndex()
{
    return this->classIndex;
}

bool MyRecognition::recognize(string filename)
{
    ...
    else
    {
        ...
        if( classIndex >= 0 )
        {
            ...
            this->description = string(classDescription);
            this->confidence = to_string(confidence);
            this->classIndex = to_string(classIndex);
        }
        else
        {
